...
--v1.2.0
-- Galaxy Hub
ScriptHubButtons:Cheat("Button", "Galaxy Hub", function()
   loadstring(game:HttpGet(('https://raw.githubusercontent.com/LaziestBoy/Krnl-Hub/master/Krnl-Hub.lua'), true))()
end)
--v1.2.1
GuisCategory:Cheat("Button", "Spotify", function()
   loadstring(game:HttpGet("https://raw.githubusercontent.com/Marethyu9999/local_sided_script_collection_v2/for_the_most_games/spotify.lua"))();
end)